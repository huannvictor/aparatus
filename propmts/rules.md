...
- SEMPRE tenha uma abordagem Tailwind first antes de criar estilos na propriedade `styles` dos componentes.
...
- SEMPRE corrija os erros de lint com o Biome.
- SEMPRE que for incluir classes css nos componentes, use o padrão do Biome.
